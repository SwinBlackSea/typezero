...
/// system automatic text completion / replacement UI, which shows an empty
/// floating dropdown while editing; an NSTextField with every automatic
/// editing feature disabled removes it.
